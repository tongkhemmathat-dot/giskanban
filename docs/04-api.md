...
- แคชอีเวนต์เป็นแบบ wipe-and-reinsert ต่อรอบ poll ในช่วง "วันนี้ −14 วัน ถึง +14 วัน" (ครอบคลุมสัปดาห์ปัจจุบันเต็มสัปดาห์ไม่ว่าวันนี้จะตรงกับวันไหน รวมถึงสัปดาห์ก่อนหน้าที่ปุ่ม "‹" ในหน้าปฏิทินเปิดดูได้) — `GET /events` อ่านจากแคชเสมอ ไม่ fetch ลิงก์สด; นัดประชุมที่เกิดซ้ำ (RRULE) รองรับเฉพาะรูปแบบพื้นฐาน (DAILY/WEEKLY/MONTHLY) ดู comment ใน `server/utils/ics.js`
